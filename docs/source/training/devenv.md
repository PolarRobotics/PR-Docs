...
2. Change the build environment from `Default` to `env:robot`. When clicking the `Default (PR-ESPIDFCodebase` text, a dropdown menu will appear at the top. Select `env:robot`.
